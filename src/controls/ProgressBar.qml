...
QtControls.ProgressBar {
    id: progressBar
    //style: Qt.createComponent(Styles.StyleSettings.path + "/ProgressBarStyle.qml", progressBar)
    style: Qt.createComponent("Styles/" + Styles.StyleSettings.name + "/ProgressBarStyle.qml", progressBar)
}
